...
# [vConsole](https://github.com/Tencent/vConsole)使用教程
...
`option` 是一个选填的 object 对象，具体配置定义请参阅 [公共属性及方法](https://github.com/Tencent/vConsole/blob/e70d998ca3805efecceeae89266eb20d1d7e4d9e/doc/public_properties_methods_CN.md)。
