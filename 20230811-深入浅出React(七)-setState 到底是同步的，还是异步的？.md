...
<iframe src="https://codesandbox.io/embed/unruffled-shadow-s794y3?fontsize=14&hidenavigation=1&module=%2Fsrc%2FApp.js&theme=dark"
     style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
     title="unruffled-shadow-s794y3"
...
![image-20230811113947942](https://s2.loli.net/2023/08/11/zTjPE5IBuJkfMc2.png)

> 注意这里是使用了`ReactDom.render`方法（同步），如果使用React18最新的语法`createRoot`(异步)，就会是以下的输出：
>
> ![image-20230811112316603](https://s2.loli.net/2023/08/11/CrobaHLIhYspmWK.png)
>
> ```jsx
...
![图片3.png](https://s2.loli.net/2023/08/11/INnbBz9MRf3iOWg.png)
...
![图片5.png](https://s2.loli.net/2023/08/11/HnNdRhFuO7PCY9x.png)
...
![图片6.png](https://s2.loli.net/2023/08/11/mtxulXfHh7IZaYi.png)
...
![3.png](https://s2.loli.net/2023/08/11/NG3i9YUCIfnHhLg.png)
